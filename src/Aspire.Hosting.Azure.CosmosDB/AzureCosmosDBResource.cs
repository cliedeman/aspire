    ...
    IAzurePrivateEndpointTarget
{
    ...
    internal bool IsPreviewEmulator =>
        ...
        imageName.StartsWith($"{CosmosDBEmulatorContainerImageTags.Registry}/{CosmosDBEmulatorContainerImageTags.Image}:{CosmosDBEmulatorContainerImageTags.TagVNextPreview}");
